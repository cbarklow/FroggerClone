		...
		switch (_index) {
			...
			case 1:
				for (i = 0; i < element_x.length; i++) {
					sprite = new Monster("skeleton_", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
			...
			case 2:
				for (i = 0; i < element_x.length; i++) {
					sprite = new Monster("mummy_", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					_elements.add(sprite);	
				}
			...
			case 3:
				for (i = 0; i < element_x.length; i++) {
					sprite = new Monster("zombie_", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					_elements.add(sprite);	
				}
			...
			case 4:
				for (i = 0; i < element_x.length; i++) {
					sprite = new Monster("vampire_", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					_elements.add(sprite);	
				}
			...
			case 5:
				for (i = 0; i < element_x.length; i++) {
					sprite = new Monster("redskull_", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					_elements.add(sprite);	
				}
			break;
			
			
			//FLOORS AND DISAPPEARING FLOORS!!!!
			case 7:
				...
				for (i = 0; i < element_x.length; i++) {
					sprite = new MysteryTile(_game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index], element_type[i]);
					_elements.add(sprite);	
				}
			...
			case 8:
				for (i = 0; i < element_x.length; i++) {
					sprite = new FloatingFloor("floor1", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					_elements.add(sprite);	
				}
			break;
			case 9:
				for (i = 0; i < element_x.length; i++) {
					sprite = new FloatingFloor("floor3", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					_elements.add(sprite);	
				}
			break;
			case 10:
			...
			case 11:
				for (i = 0; i < element_x.length; i++) {
					if (i == 1) {
						sprite = new Dragon(_game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);	
					} else {
						sprite = new FloatingFloor("floor2", _game, element_x[i], _game.screenHeight - TIER_ELEMENT_Y[_index]);
					}
					_elements.add(sprite);	
				}
			break;
